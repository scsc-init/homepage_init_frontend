      ...
      <table className="adm-table">
        ...
        <tbody>
          {filteredPigs.map((pig) => (
            <tr key={pig.id}>
              <td className="adm-td">{pig.id}</td>
              <td className="adm-td">{pig.title}</td>
              <td className="adm-td">{pig.status}</td>
              <td className="adm-td">{pig.year}</td>
              <td className="adm-td">{pig.semester}</td>
              <td className="adm-td">
