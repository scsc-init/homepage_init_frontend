...
export default function Home() {
  ...
  return (
    <div id="Home">
      <div id="HomeImageContainer" className="FadeOnScroll">
        <h3
        ...
        <div className="TitleContainer FadeOnScroll">
          <h1 className="FadeInText">Seoul National University</h1>
          <h1 className="FadeInText">Computer Study Club</h1>
        </div>
        <div className="TitleContainer FadeOnScroll">
        ...
        <div id="HomeClubroomContainer" className="FadeOnScroll">
          ...
          <div className="ClubroomFacilityList">
            {[
              {
                title: "고성능 컴퓨터",
                description: "개발 및 딥러닝 작업이 가능한 워크스테이션",
                image: "/img1.jpg",
              },
              {
                title: "소파 & 회의 공간",
              ...
              {
                title: "음료 및 간식",
                description: "커피머신과 간식을 마음껏 즐길 수 있어요!",
                image: "/img3.jpg",
              },
              {
                title: "책과 자료들",
